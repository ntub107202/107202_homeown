package ntub107202.hostel.Schedule.view;
...
import ntub107202.hostel.R;
import ntub107202.hostel.Schedule.adapter.DateMonthAdapter;
import ntub107202.hostel.Schedule.utils.DataUtils;
...
public class DatePopupWindow extends PopupWindow implements View.OnClickListener{
    ...
    public DatePopupWindow(final Context context,String dateString) {
        ...
        conentView = inflater.inflate(R.layout.calender, null);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (onItemClick!=null && !TextUtils.isEmpty(adapter.getItem(position).date)){
                    ...
                    currentDateTv.setText("當前月份："+DataUtils.formatDate(adapter.getItem(position).date,"yyyy-MM"));
